...
class Intent():
    """Class for a Chatbot Intent. An intent is the user's intention when he interacts with the chatbot.
    
    Attributes: 
    tag: class of the intent, e.g. greeting, goodbye, rent car etc.
    pattern: The sentences, the user can say to the bot to signalize his intent
    responses: The chatbot's possible responses"""
    tag = 
